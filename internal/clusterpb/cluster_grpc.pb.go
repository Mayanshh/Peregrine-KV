...
const (
	Raft_RequestVote_FullMethodName   = "/peregrinekv.cluster.Raft/RequestVote"
	Raft_AppendEntries_FullMethodName = "/peregrinekv.cluster.Raft/AppendEntries"
)
...
var Raft_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "peregrinekv.cluster.Raft",
