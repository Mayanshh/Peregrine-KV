...
const (
	KV_Put_FullMethodName    = "/peregrinekv.kv.KV/Put"
	KV_Get_FullMethodName    = "/peregrinekv.kv.KV/Get"
	KV_Delete_FullMethodName = "/peregrinekv.kv.KV/Delete"
)
